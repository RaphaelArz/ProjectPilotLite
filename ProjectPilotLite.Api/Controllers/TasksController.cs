...
public class TasksController : ControllerBase
{
    ...
    /// <response code="200">Liste des tâches récupérée avec succès.</response>
    ...
    /// </summary>
    /// <param name="projectId">Identifiant du projet.</param>
    /// <param name="dto">Données de la tâche à créer.</param>
    ...
    /// <param name="dto">Nouveau statut de la tâche.</param>
